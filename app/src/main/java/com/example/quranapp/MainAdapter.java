...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.MainViewHolder>{
    ...
    public MainAdapter(List<ChaptersItem> results, List<AudioItem> result) {
        this.surah = results;
        this.audio = result;
    }
    @NonNull
    ...
    public void onBindViewHolder(@NonNull MainAdapter.MainViewHolder holder, int position) {
        ...
        AudioItem aud = audio.get(position);
    ...
    public void setData(List<ChaptersItem> data, List<AudioItem> data1){
        // Surah
        surah.clear();
        surah.addAll(data);
        // Terjemahan
